...
model = Sequential([
    Dense(64, activation='relu', input_shape=(3,)),  # Couche d'entrée avec 3 nœuds
...
num_correct_predictions = len(results_df[(results_df['FTR'] == results_df['Predictions']) & (results_df['FTR'] != 'Div')])

print(f'Accuracy: {num_correct_predictions / total_rows * 100}%')
